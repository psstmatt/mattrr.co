...
(function($) {
  $.fn.sticky = function(options) {
    ...
    var settings = {
      ...
      'onStart': '',
      // When the element returns to the start
    ...
    this.each(function() {
      ...
      var sticky = {
        ...
        'init': function($this) {
          ...
          // Determine Sticky Element, Mode and Units (Force Animate Mode in Internet Explorer)
          ...
          settings.states = [
          settings.classes.start, settings.classes.sticky, settings.classes.stopped].join(' ');
